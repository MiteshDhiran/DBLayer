...
namespace ConnectAndSell.DataAccess.Repository.EFCore1
{
    ...
    public class Core1RepositoryProvider<K> : RepositoryProviderBase where K: DbContext
    {
        ...
        private static Tuple<Dictionary<object, List<ChangeTrackingInfo>>,bool> SaveRecordsInternal<T>(DbContext dbContext,ORMModelMetaInfo model,bool isAuditingRequired, string currentUser,DateTimeOffset currentDateTimeOffset, List<T> recordList) where T: ICoreEntity
        {
