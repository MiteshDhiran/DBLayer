...
{
    /// <summary>
    /// EntitySetPropertyInfo class
    /// </summary>
    public class EntitySetPropertyInfo
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntitySetPropertyInfo"/> class.
        /// </summary>
        ...
        public EntitySetPropertyInfo(IColumnNetInfo propertyInfo, string propertyName, Type entitySetTableType, string entitySetTableName, string parentTableName, Type parentTableType, List<string> parentTableColumnNames, List<string> childTableColumnNames)
        {
