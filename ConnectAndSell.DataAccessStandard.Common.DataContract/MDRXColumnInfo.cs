...
namespace ConnectAndSell.DataAccessStandard.Common.DataContract
{
    ...
    /// <summary>
    ///  MDRXColumnInfo class
    /// </summary>
    public class MDRXColumnInfo
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MDRXColumnInfo"/> class.
        /// </summary>
        ...
        /// dbType
        /// </exception>
        public MDRXColumnInfo(string columnName, IColumnNetInfo propertyInfo, string propertyName, Type propertyClrType,
